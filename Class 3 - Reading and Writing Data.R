...
input_csv.df <- read.csv(file="F:\\Study\\Term 4\\AMMA\\AMMA 2017\\Data\\data_2017\\binary.csv")

input_csv.df1 <- read.csv(file="F:\\Study\\Term 4\\AMMA\\AMMA 2017\\Data\\data_2017\\binary.csv")

# reset directory and read file
setwd("F:\\MICA\\Study\\Term 4\\AMMA\\AMMA 2017\\Data\\data_2017")
...
csv_file <- read.table(file="F:\\MICA\\Study\\Term 4\\AMMA\\AMMA 2017\\Data\\data_2017\\binary.csv",
                                header = TRUE, 
                                sep = ',')

## Read a Tab Delimited file
input_tabdlmtd.df <- read.table(file="F:\\MICA\\Study\\Term 4\\AMMA\\AMMA 2017\\Data\\data_2017\\tab_delimited_data.txt",
                                header = TRUE, 
                                sep = '\t')
...
input_dollar.df <- read.table(file="F:\\MICA\\Study\\Term 4\\AMMA\\AMMA 2017\\Data\\data_2017\\dollar_delimited_data.txt",
                                header = TRUE, 
                                sep = '$')
...
bank_ins = read.sas7bdat("F:\\MICA\\Study\\Term 4\\AMMA\\AMMA 2017\\Data\\data_2017\\bank_additional_full.sas7bdat")
names(bank_ins)
...
write.csv(tt, "F:\\MICA\\Study\\Term 4\\AMMA\\AMMA 2017\\Data\\data_2017\\mtcars.csv",
          row.names=F
)
